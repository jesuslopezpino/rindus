...
privileged aspect CustomerService_Roo_Service {
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.addToPedidos(Customer customer, Iterable<Long> pedidosToAdd);
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.removeFromPedidos(Customer customer, Iterable<Long> pedidosToRemove);
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.setPedidos(Customer customer, Iterable<Long> pedidos);
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.addToReservas(Customer customer, Iterable<Long> reservasToAdd);
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.removeFromReservas(Customer customer, Iterable<Long> reservasToRemove);
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.setReservas(Customer customer, Iterable<Long> reservas);
