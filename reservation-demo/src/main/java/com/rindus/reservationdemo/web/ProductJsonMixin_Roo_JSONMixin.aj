...
privileged aspect ProductJsonMixin_Roo_JSONMixin {
     ...
     */
    @JsonIgnore
    private List<PricePerProduct> ProductJsonMixin.preciosPorProducto;
     ...
     * @return List
     */
    public List<PricePerProduct> ProductJsonMixin.getPreciosPorProducto() {
     ...
     */
    public void ProductJsonMixin.setPreciosPorProducto(List<PricePerProduct> preciosPorProducto) {
