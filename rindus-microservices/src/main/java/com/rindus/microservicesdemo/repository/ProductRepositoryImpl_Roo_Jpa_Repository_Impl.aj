...
import com.rindus.microservicesdemo.domain.QProduct;
import com.rindus.microservicesdemo.repository.ProductRepositoryCustom;
import com.rindus.microservicesdemo.repository.ProductRepositoryImpl;
...
privileged aspect ProductRepositoryImpl_Roo_Jpa_Repository_Impl {
     ...
     * 
     */
    public static final String ProductRepositoryImpl.PRICE = "price";
    ...
    public Page<Product> ProductRepositoryImpl.findAll(GlobalSearch globalSearch, Pageable pageable) {
        ...
        Path<?>[] paths = new Path<?>[] {product.price,product.name,product.description};        
